...
class AppRedirect implements RouteRedirect {
  final AppService appService;
  AppRedirect(this.appService);
  ...
  String? redirect(String currentLocation) {
    ...
    final isGoingToLogin = currentLocation == '/auth';
    final isGoingToInit = currentLocation == '/splash';
    final isGoingToOnboard = currentLocation == '/onboarding';
